  ...
  render () {
    ...
    return <Grid container justify='center' spacing={24} className={classes.root}>
      ...
      <Grid item xs={xs}>
        ...
        <Typography gutterBottom variant='body2' className={classes.font}>
          {`
            This writeup has been inspired by the Critical Theory class on technology taught by `}<a href='http://www.morehshin.com/' target='_blank'>Moreshin Allahyari</a> {`at the School for Poetic Computation in NYC which I am currently attending as a student in the spring term 2018.
          `}
        </Typography>
      </Grid>
